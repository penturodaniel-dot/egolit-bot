...
"дитячий спектакль або розвага для дітей" → {{"intent":"event","category_names":[],"event_category":"діти","search_text":null,"date_filter":null,"max_price":null,"needs_clarification":false,"clarification_question":null}}
...
"вечірка або клуб для друзів" → {{"intent":"event","category_names":[],"event_category":"клуби","search_text":null,"date_filter":null,"max_price":null,"needs_clarification":false,"clarification_question":null}}
