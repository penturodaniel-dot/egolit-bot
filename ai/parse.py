...
- Встановлюй true ТІЛЬКИ якщо неможливо визначити intent (незрозуміло: послуга чи подія чи заявка).
- Якщо intent визначено (service або event) — завжди false, навіть якщо деталі нечіткі.
- НЕ уточнюй категорію події — просто шукай серед усіх подій.
...
- Встановлюй тільки якщо є конкретне ім'я виконавця, назва події або специфічне ключове слово.
- НЕ встановлюй для загальних описів настрою чи нагоди (романтичне, для дітей, для друзів, побачення тощо).
- Якщо запит загальний ("яка подія підійде для...") — завжди null.
