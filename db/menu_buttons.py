...
_DEFAULT_BUTTONS = [
    ...
    (None, "Ідея для побачення",      "💑", "ai_search",
     "Романтичний захід або вечір для двох у Дніпрі", 2),
    (None, "Куди з дітьми",           "👨‍👩‍👧", "ai_search",
     "Цікавий захід або розвага для дітей у Дніпрі", 3),
    (None, "Відпочити з друзями",     "🍻", "ai_search",
     "Цікавий захід або розвага для компанії друзів у Дніпрі", 4),
...
_PROMPT_MIGRATIONS: dict[str, str] = {
    ...
    "Ідея для побачення":
        "Романтичний захід або вечір для двох у Дніпрі",
    "Куди з дітьми":
        "Цікавий захід або розвага для дітей у Дніпрі",
    "Відпочити з друзями":
        "Цікавий захід або розвага для компанії друзів у Дніпрі",
    "Знайти виконавця":
