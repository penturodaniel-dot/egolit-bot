...
_DEFAULT_BUTTONS = [
    ...
    (None, "Ідея для побачення",      "💑", "ai_search",
     "Яка подія в афіші підійде для романтичного побачення у Дніпрі?", 2),
    (None, "Куди з дітьми",           "👨‍👩‍👧", "ai_search",
     "Яка подія в афіші підійде для відпочинку з дітьми у Дніпрі?", 3),
    (None, "Відпочити з друзями",     "🍻", "ai_search",
     "Яка подія в афіші підійде для відпочинку з компанією друзів у Дніпрі?", 4),
...
_PROMPT_MIGRATIONS: dict[str, str] = {
    ...
    "Ідея для побачення":
        "Яка подія в афіші підійде для романтичного побачення у Дніпрі?",
    "Куди з дітьми":
        "Яка подія в афіші підійде для відпочинку з дітьми у Дніпрі?",
    "Відпочити з друзями":
        "Яка подія в афіші підійде для відпочинку з компанією друзів у Дніпрі?",
    "Знайти виконавця":
