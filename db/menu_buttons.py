...
_DEFAULT_BUTTONS = [
    ...
    (None, "Куди піти сьогодні",   "🌆", "ai_search",    "куди піти сьогодні ввечері у Дніпрі", 0),
    (None, "Події на вихідні",     "📅", "ai_search",    "цікаві події та заходи на вихідні у Дніпрі", 1),
    (None, "Ідея для побачення",   "💑", "ai_search",    "романтичне місце або ідея для побачення у Дніпрі", 2),
    (None, "Куди з дітьми",        "👨‍👩‍👧", "ai_search", "куди піти з дітьми у Дніпрі, розваги для дітей", 3),
    (None, "Відпочити з друзями",  "🍻", "ai_search",    "де відпочити з друзями у Дніпрі", 4),
    (None, "Куди поїхати недалеко","🚗", "ai_search",    "куди поїхати на вихідні недалеко від Дніпра", 5),
    (None, "Свій запит",           "✍️", "custom_query", None, 6),
    (None, "Поговорити з менеджером", "📞", "manager",   None, 7),
]
