...
_DEFAULT_BUTTONS = [
    ...
    (None, "Ідея для побачення",      "💑", "ai_search",
     "Яка подія є в афіші Дніпра для закоханих?", 2),
    (None, "Куди з дітьми",           "👨‍👩‍👧", "ai_search",
     "Яка подія є в афіші Дніпра для дітей?", 3),
    (None, "Відпочити з друзями",     "🍻", "ai_search",
     "Яка подія є в афіші Дніпра для відпочинку з друзями?", 4),
...
_PROMPT_MIGRATIONS: dict[str, str] = {
    ...
    "Ідея для побачення":
        "Яка подія є в афіші Дніпра для закоханих?",
    "Куди з дітьми":
        "Яка подія є в афіші Дніпра для дітей?",
    "Відпочити з друзями":
        "Яка подія є в афіші Дніпра для відпочинку з друзями?",
    "Знайти виконавця":
        "Знайди виконавця або артиста для свята у Дніпрі",
    "Куди поїхати недалеко":
        "Бази відпочітку, локації для відпочинку у Дніпрі найближчим часом",
}
